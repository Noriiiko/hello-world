...
def generate_routefile():
    ...
    traci.start([sumoBinary, "-c", "sumot5.sumocfg"])  # 打开对应的sumo文件
...
def setWindow():
    ...
    Button_1 = ttk.Button(root, text="Enter", command=checkSpeed)
    Button_1.place(x=50, y=40)
    Button_2 = ttk.Button(root, text="Reset", command=reset)
